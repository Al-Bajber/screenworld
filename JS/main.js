...
for (let i = 0; i < buttons.length; i++) {
  buttons[i].addEventListener("click", () => {
    if (i === 0) {
      heading.innerText = "Vision in motion";
      talks.innerText = "ScreenWorld transforms ideas into impactful advertising. Driven by innovation and storytelling, we create dynamic experiences that engage and inspire.";
      click.innerText = "Learn more about us";
      image.style.background = "url(../images/slideshow/two-partners.jpeg)"
      buttons[i].style.background = "#fff"
      buttons[1].style.background = "none"
      buttons[2].style.background = "none"
    } else if (i === 1) {
      heading.innerText = "Strategic Advertising";
      talks.innerText = "ScreenWorld crafts high-impact campaigns, blending innovation with precision to connect brands with their audience.";
      click.innerText = "Explore our services";
      image.style.background = "url(../images/slideshow/team-meeting-renewable-energy-project.jpeg)"
      buttons[i].style.background = "#fff"
      buttons[0].style.background = "none"
      buttons[2].style.background = "none"
    } else if (i === 2) {
      heading.innerText = "Let's connect";
      talks.innerText = "Reach out to ScreenWorld for innovative and impactful advertising solutions tailored to elevate your brand’s visibility and engagement.";
      click.innerText = "Get in touch";
      image.style.background = "url(../images/slideshow/medium-shot-business-women-high-five.jpeg)"
      buttons[i].style.background = "#fff"
      buttons[1].style.background = "none"
      buttons[0].style.background = "none"
    }
